...
public class OvergrowthTextureFile( string absFilePath, string relFilePath ) : ResourceLoader<OvergrowthMount>
{
	protected override object Load()
	{
		var ddsFile = DdsFile.Load( absFilePath );
